About py6s-feedstock
====================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/py6s-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=3191&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/py6s-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `py6s` can be installed with `conda`:
...
It is possible to list all of the versions of `py6s` available on your platform with `conda`:
...
```
mamba search py6s --channel conda-forge
```
...
mamba repoquery search py6s --channel conda-forge

# List packages depending on `py6s`:
mamba repoquery whoneeds py6s --channel conda-forge

# List dependencies of `py6s`:
mamba repoquery depends py6s --channel conda-forge
```
